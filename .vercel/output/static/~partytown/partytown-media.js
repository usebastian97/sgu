  ...
  const C = (e, t) => {
      const o = {
        ...
        l = S(
          ...
          class extends e {
            addColorStop(...e) {
              r(this, ['addColorStop'], e, T.NonBlocking);
            }
          }
        ),
        f = S(
          ...
          class extends e {
            setTransform(...e) {
              r(this, ['setTransform'], e, T.NonBlocking);
            }
          }
        ),
        h = (e, t, o) => {
          const i = e[a],
            d = s(),
            f = { [a]: i, [c]: d, [u]: [] },
            h = r(e, ['getContext'], [t, o], T.Blocking, d),
            g =
                ...
                'string' == typeof t && t in h
                  ? 'function' == typeof h[t]
                    ? (...e) => {
                        ...
                        var n;
                        const o = g.includes(t) ? T.Blocking : T.NonBlocking;
                        return r(f, [t], e, o);
                      }
                    : h[t]
                  : e[t],
        ...
        g = (e, t, o) => {
          const i = e[a],
            d = s(),
            l = { [a]: i, [c]: d, [u]: [] },
            f = r(e, ['getContext'], [t, o], T.Blocking, d),
            h = {
              get: (e, t) =>
                'string' == typeof t
                  ? 'function' != typeof f[t]
    ...
    w = (e, u, d, y) => {
      ...
      const b = class extends e {
        ...
        E = class {
          constructor(e) {
            ...
            return new Proxy(
              {
                addEventListener(...t) {
                  r(e, [n, 'addEventListener'], t, T.NonBlockingNoSideEffect);
                },
                ...
                removeEventListener(...t) {
                  r(e, [n, 'removeEventListener'], t, T.NonBlockingNoSideEffect);
                },
              },
        ...
        N = S(
          ...
          class extends Array {
            ...
            addEventListener(...e) {
              r(this[l], ['sourceBuffers', 'addEventListener'], e, T.NonBlockingNoSideEffect);
            }
            removeEventListener(...e) {
              r(this[l], ['sourceBuffers', 'removeEventListener'], e, T.NonBlockingNoSideEffect);
            }
          }
        ),
        L = S(
          ...
          ((B = class extends u {
            constructor(e) {
              (super(e[a], e[c], ['sourceBuffers']), (this[v] = []), (this[l] = e));
            }
            abort() {
              const e = C(this);
              r(this, [e, 'appendWindowStart'], p, T.Blocking);
            }
            addEventListener(...e) {
              const t = C(this);
              r(this, [t, 'addEventListener'], e, T.NonBlockingNoSideEffect);
            }
            appendBuffer(e) {
            ...
            get buffered() {
              const e = this[l],
                t = C(this);
              return new R(e[a], e[c], ['sourceBuffers', t, 'buffered']);
            }
            changeType(e) {
              const t = C(this);
              r(this, [t, 'changeType'], [e], T.NonBlocking);
            }
            get mode() {
              const e = C(this);
            ...
            removeEventListener(...e) {
              const t = C(this);
              r(this, [t, 'removeEventListener'], e, T.NonBlockingNoSideEffect);
            }
            get timestampOffset() {
              const e = C(this);
        ...
        w = (e) => {
          if (e[g].length) {
            if (!e.updating) {
              ...
              if (t) {
                const n = C(e);
                r(e, [n, t[0]], t[1], T.NonBlockingNoSideEffect, void 0, t[2]);
              }
            }
            setTimeout(() => w(e), 50);
          }
        ...
        I = {
          buffered: {
            get() {
              return (
                this[m] ||
                  ((this[m] = new R(this[a], this[c], ['buffered'])),
                  setTimeout(() => {
                    this[m] = void 0;
                  }, 5e3)),
                this[m]
      ...
      S(
        ...
        class extends u {
          ...
          clearLiveSeekableRange() {
            r(this, ['clearLiveSeekableRange'], p, T.NonBlocking);
          }
          get duration() {
          ...
          endOfStream(e) {
            r(this, ['endOfStream'], [e], T.NonBlockingNoSideEffect);
          }
          get readyState() {
          ...
          removeSourceBuffer(e) {
            const t = C(e);
            t > -1 && (this[h].splice(t, 1), r(this, ['removeSourceBuffer'], [t], T.Blocking));
          }
          setLiveSeekableRange(e, t) {
            r(this, ['setLiveSeekableRange'], [e, t], T.NonBlocking);
          }
          get sourceBuffers() {
            return this[h];
          }
          static isTypeSupported(e) {
            if (!W.has(e)) {
              const t = r(y, ['MediaSource', 'isTypeSupported'], [e]);
              W.set(e, t);
            }
            return W.get(e);
          }
      ...
      const D = (y.URL = k('URL', class extends URL {}));
      ('audioTracks' in y.HTMLMediaElement.prototype &&
        (S(y, 'AudioTrackList', E),
        S(y, 'AudioTrack', b),
        (I.audioTracks = {
          get() {
            return new E(this);
        ...
        i(y.HTMLMediaElement, I),
        (D.createObjectURL = (e) => r(y, ['URL', 'createObjectURL'], [e])),
        (D.revokeObjectURL = (e) => r(y, ['URL', 'revokeObjectURL'], [e])));
    },
    W = new Map();
  e.f = (e, t, n, r, o) => {
    (o.map((e) => {
