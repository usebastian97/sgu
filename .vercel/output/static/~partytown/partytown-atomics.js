((e) => {
  const t = () => {},
    ...
    o = (e, t) => e.startsWith(t),
    i = (e) =>
      !(o(e, 'webkit') || o(e, 'toJSON') || o(e, 'constructor') || o(e, 'toString') || o(e, '_')),
  ...
  const R = (e, t) => {
      if (e) return ((t = y.get(e)) || (t = e[d]) || M(e, (t = a())), t);
    },
    A = (e, t, r, n, o) => {
      if ((r = f[e]) && r.U) {
        if (e === t) return r.U;
        if (((n = r.U.document), (o = t.split('.').pop()) === w.document)) return n;
        if (o === w.documentElement) return n.documentElement;
        if (o === w.head) return n.head;
        if (o === w.body) return n.body;
      }
      return h.get(t);
    },
    M = (e, t, r) => {
          ...
          .map(
            (r) =>
              (n.prototype[r] = function (...n) {
                t.postMessage([v.CustomElementCallback, e, R(this), r, n]);
              })
          ),
        ...
        ? 'string' === i || 'number' === i || 'boolean' === i || null == t
          ...
          : 'function' === i
            ...
            : (r = r || new Set()) && Array.isArray(t)
              ? r.has(t)
                ? [E.Array, []]
                : r.add(t) && [E.Array, t.map((t) => D(e, t, r))]
              : 'object' === i
                ? j(t)
                  ? [E.Error, { name: t.name, message: t.message, stack: t.stack }]
                  : '' === (a = n(t))
                    ? [E.Object, {}]
                    : 'Window' === a
                      ? [E.Instance, [e, e]]
                      : 'HTMLCollection' === a || 'NodeList' === a
                        ? [E.NodeList, Array.from(t).map((t) => D(e, t, r)[1])]
                        : a.endsWith('Event')
                          ? [E.Event, U(e, t, r)]
                          : 'CSSRuleList' === a
                            ? [E.CSSRuleList, Array.from(t).map(W)]
                            : o(a, 'CSS') && a.endsWith('Rule')
                              ? [E.CSSRule, W(t)]
                              : 'CSSStyleDeclaration' === a
                                ? [E.CSSStyleDeclaration, U(e, t, r)]
                                : 'Attr' === a
                                  ? [E.Attr, [t.name, t.value]]
                                  : t.nodeType
                                    ? [E.Instance, [e, R(t), s(t), c]]
                                    : [E.Object, U(e, t, r, !0, !0)]
                : void 0
        : t,
    U = (e, t, r, o, s, a, c, l) => {
      if (((a = {}), !r.has(t)))
        for (c in (r.add(t), t))
          i(c) &&
            ...
            (o || 'function' != typeof l) && (s || '' !== l) && (a[c] = D(e, l, r)));
      return a;
    },
    W = (e) => {
      let t,
  ...
  const j = (t) => {
    ...
    V = (e, { V: t, w: r, L: n }, o) => (
      (o = g.get(n)) ||
        ((o = function (...o) {
          e.postMessage([v.RefHandlerCallback, { V: t, w: r, L: n, R: D(t, this), b: D(t, o) }]);
        }),
        g.set(n, o)),
      o
    ),
    $ = (e) => new ('detail' in e ? CustomEvent : Event)(e.type, e),
    z = (e, t, r, n) => {
      for (n in ((r = {}), t)) r[n] = F(e, t[n]);
      return r;
    },
          ...
          ((c = p === u - 1),
            ...
            !f[o] &&
              ...
              (await new Promise((e) => {
                let t = 0,
                  r = () => {
                    f[o] || t++ > 1e3 ? e() : requestAnimationFrame(r);
                  };
                r();
              })),
            i[0] === N.GlobalConstructor && i[1] in f[o].U
              ? M(new f[o].U[i[1]](...F(e, i[2])), n.w)
              : ((s = A(o, n.w)),
                s
                  ? ((a = J(e, o, s, i, c, n.r)),
                    n.d &&
                    ...
                    c && (l.M = D(o, a, void 0, void 0, void 0, n.w)))
                  : (l.p = n.w + ' not found')));
        } catch (e) {
    ...
    J = (e, t, o, i, s, a) => {
      let c,
        ...
        h = r(i);
      for (; m < h; m++) {
        ((l = i[m]), (c = i[m + 1]), (u = i[m - 1]));
        try {
          if (!Array.isArray(c))
            if ('string' == typeof l || 'number' == typeof l) {
              if (m + 1 === h && a) return ((d = {}), a.map((e) => (d[e] = o[e])), d);
              o = o[l];
            } else {
              if (c === N.SetValue) return void (o[u] = F(e, l));
              if (
                'function' == typeof o[u] &&
                ((p = F(e, l)),
                'define' === u && 'CustomElementRegistry' === n(o) && (p[1] = B(t, e, p[1])),
                'insertRule' === u && p[1] > r(o.cssRules) && (p[1] = r(o.cssRules)),
                (o = o[u].apply(o, p)),
                'play' === u)
              )
    ...
    G = (e, t) => {
      ...
      c && c.body
        ? ((n = c.querySelector(d)),
          ...
          n
            ? ((n.dataset.ptid = o = R(n, s)),
              (i = { V: s, w: o }),
              n.src ? ((i.S = n.src), (i.H = n.dataset.ptsrc || n.src)) : (i.j = n.innerHTML),
              e.postMessage([v.InitializeNextScript, i]))
            : (t.x ||
                ((t.x = 1),
                ((e, t, n) => {
                  let o,
                    ...
                    c = (r, n) =>
                      e.postMessage([v.ForwardMainTrigger, { V: t, q: r, b: D(t, Array.from(n)) }]);
                  if (
                    ((n._ptf = void 0),
                    a.map((e) => {
                      const [t, { preserveBehavior: o }] = ((e) => {
    ...
    K = (e, t, r) => {
      if (!y.has(r)) {
        ...
        const a = [],
          ...
          u = o.pushState.bind(o),
          p = o.replaceState.bind(o),
          d = (r, o, i, s) => () => {
            e.postMessage([
              v.LocationUpdate,
              { V: t, type: r, state: o, url: n.baseURI, newUrl: i, oldUrl: s },
            ]);
          };
        ((o.pushState = (e, t, r) => {
          (u(e, t, r), c(d(S.PushState, e, null == r ? void 0 : r.toString())));
        }),
          (o.replaceState = (e, t, r) => {
            (p(e, t, r), c(d(S.ReplaceState, e, null == r ? void 0 : r.toString())));
          }),
          r.addEventListener('popstate', (e) => {
            c(d(S.PopState, e.state));
          }),
          r.addEventListener('hashchange', (e) => {
            c(d(S.HashChange, {}, e.newURL, e.oldURL));
          }),
        ...
        e
          ...
          .map((e) => {
            const t = e[0],
              r = e[1],
              o = n(t);
            return [o, x[o].prototype, t, r];
          })
          .map(([e, n, o, i]) => Q(r, t, e, n, o, i)),
        t
      );
    },
    Z = (e, t, r) => {
    ...
    Q = (e, t, r, o, i, a) => {
      if (!e.has(r)) {
        ...
        const c = Object.getPrototypeOf(o),
          l = n(c),
          u = [],
          p = Object.getOwnPropertyDescriptors(o);
        Q(e, t, l, c, i, a);
        for (const e in p) ee(u, i, e);
        t.push([r, l, u, a, s(i)]);
      }
    },
    ee = (e, t, r, o, s, a) => {
      try {
        i(r) &&
          isNaN(r[0]) &&
          'all' !== r &&
          ('function' == (s = typeof (o = t[r]))
            ? (String(o).includes('[native') || Object.getPrototypeOf(t)[r]) &&
              e.push([r, b.Function])
            : 'object' === s && null != o
              ? 'Object' !== (a = n(o)) &&
                'Function' !== a &&
                self[a] &&
                e.push([r, o.nodeType || a])
              : 'symbol' !== s &&
                (r.toUpperCase() === r ? e.push([r, b.Property, o]) : e.push([r, b.Property])));
      } catch (e) {
        console.warn(e);
      }
    },
  ...
  let re;
  (async () => {
    const e = new SharedArrayBuffer(1073741824),
      t = new Int32Array(e);
    return (r, n) => {
      const o = n[0],
        i = n[1];
      if (o === v.MainDataRequestFromWorker) {
        const t = (() => {
          const e = L.createElement('i'),
            t = L.createTextNode(''),
            r = L.createComment(''),
            n = L.createDocumentFragment(),
            o = L.createElement('p').attachShadow({ mode: 'open' }),
            i = te(x, 'IntersectionObserver'),
            s = te(x, 'MutationObserver'),
            a = te(x, 'ResizeObserver'),
            c = x.performance,
            l = x.screen,
            u = [
              [x.history],
            ...
            m = { i: d, v: X(u, p), C: new URL(P, x.location) + '', I: origin, $tabId$: x._pttab };
          return (
            ((e, t, r) => {
              void 0 !== t[r] &&
                e.push([
            ...
            })(m.v, x, 'IntersectionObserverEntry'),
            m
          );
        })();
        ((t.P = e), r.postMessage([v.MainDataResponseToWorker, t]));
      } else
        n[0] === v.MainInterfacesRequestFromWorker
          ? r.postMessage([v.MainInterfacesResponseToWorker, Y()])
          : o === v.ForwardWorkerAccessRequest
            ? ((e, t) => {
                ...
                const r = JSON.stringify(e),
                  n = r.length;
                for (let e = 0; e < n; e++) t[e + 1] = r.charCodeAt(e);
                ((t[0] = n), Atomics.notify(t, 0));
              })
            : ((e, t, r) => {
                  ...
                  : (r = f[t[1]]) &&
                    (t[0] === v.InitializeNextScript
                      ...
                      : t[0] === v.InitializedEnvironmentScript &&
                        ((e, t, r, n, o) => {
                          ((o = t.U.document.querySelector(`[data-ptid="${r}"]`)) &&
                            (n ? (o.dataset.pterror = n) : (o.type += '-x'), delete o.dataset.ptid),
                            G(e, t));
                        })(e, r, t[2], t[3]));
              })(r, n);
    };
    ...
    e &&
      ...
      x.addEventListener('pt1', (e) => K(re, R(e.detail.frameElement), e.detail)));
  });
})(window);
